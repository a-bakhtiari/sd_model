...
**IMPORTANT**: Do NOT label variables with types like (Stock), (Flow), or (Auxiliary). That's Step 2's job. Your job is to write narratives that are mechanistically rich enough for Step 2 to infer the appropriate types.

### Required Mechanistic Elements:

**1. Accumulations (Things that build up or deplete)**
Explicitly mention what accumulates, grows, or depletes over time:
- ✅ "There is a **pool of peripheral members** that grows when newcomers join and shrinks when they advance..."
- ✅ "The **knowledge base accumulates** documentation as members contribute their experiences..."
- ✅ "The community **builds up mentoring capacity** measured in mentor-hours available per month..."
- ✅ "Trust **develops and accumulates** through repeated positive interactions..."
- ❌ "Members learn through observation" (too vague - what accumulates?)

**2. Rates and Speeds (How fast things change)**
Describe the pace, rate, or speed at which changes occur:
- ✅ "Members transition to core status at a **rate** determined by mentoring availability and individual readiness..."
- ✅ "Documentation is created at a **pace** proportional to the number of active contributors..."
- ✅ "The **speed of integration** depends on community openness and interaction frequency..."
- ✅ "Knowledge transfers **at a rate of** approximately 2-3 key concepts per mentoring session..."
- ❌ "Members become more integrated" (no rate or speed specified)
...
- ✅ "It takes **6-12 months on average** for a newcomer to develop proficiency..."
- ✅ "The benefits of documentation appear with a **3-month delay** as content gets refined and validated..."
- ✅ "Trust **builds slowly over 4-6 months** through repeated positive interactions..."
- ✅ "Reputation effects **lag 2-3 months behind** actual performance improvements..."
- ❌ "Members eventually gain expertise" (no specific time dimension)

**5. Nonlinearities (Thresholds, Saturation, Tipping Points)**
Describe non-proportional relationships:
- ✅ "Below a **critical threshold** of 5 core members, mentoring capacity becomes insufficient to sustain growth..."
- ✅ "Adoption **accelerates rapidly** once 20% of the community has adopted, creating a tipping point..."
- ✅ "Mentoring effectiveness **saturates and declines** when the mentor-to-newcomer ratio exceeds 1:10..."
- ✅ "Performance **drops sharply** when workload exceeds 80% of capacity..."
- ❌ "More mentors help more" (assumes linear relationship)

**6. Causal Drivers (What Affects What)**
State explicit cause-effect relationships:
- ✅ "Documentation quality **increases with** the number of expert contributors and review cycles..."
- ✅ "Engagement **drops when** response time exceeds 48 hours, following an exponential decay..."
- ✅ "The rate of knowledge transfer is **limited by** both available mentors and learner absorption capacity..."
- ✅ "Trust level **determines** how much tacit knowledge members are willing to share..."
- ❌ "Quality improves over time" (no causal mechanism specified)

### Example: Before vs After

**❌ Too Abstract (Vague Style):**
...
**✅ Mechanistically Rich (Target Style):**
> "There is a **pool of peripheral members** that grows when newcomers join at a rate influenced by project visibility and reputation. These newcomers **accumulate shared experiences** through observation and practice, with the **pace of experience-gathering** determined by community openness and interaction frequency (typically 3-5 interactions per week). Members **progress toward core membership** at a rate that depends on: (1) available **mentoring capacity** measured in mentor-hours per month, (2) an **average socialization period** of 6-9 months, and (3) the **effectiveness of knowledge transfer** which varies with trust levels. **Reinforcing feedback**: As more members reach core status → mentoring capacity increases → newcomer progression accelerates → more future core members. **Balancing pressure**: When the peripheral member pool grows too large relative to mentors, mentoring quality deteriorates, slowing the transition rate. **Nonlinearity**: Progress accelerates sharply after members achieve 10+ meaningful interactions, but saturates when mentor-to-newcomer ratio exceeds 1:8."

### Narrative Checklist (Use for Each Process)

Before finalizing each narrative, verify you've described:
- [ ] **Accumulations** (2-4 things that build up or deplete over time)
- [ ] **Rates/Speeds** (2-4 descriptions of how fast things change)
- [ ] **Feedback loops** (at least 1 reinforcing or balancing loop with full causal chain)
- [ ] **Time constants/delays** (specific durations: days, weeks, months)
- [ ] **Causal relationships** (what drives/limits/determines what)
- [ ] **Nonlinearities** (thresholds, saturation points, tipping points)
...
- **narrative**: Full prose description with **mechanistic detail** (write in actual sentences)
  - Describe the process flow and its role in the overall system
  - **REQUIRED**: Include accumulations, rates, feedback loops, delays, and causal mechanisms (but do NOT label types)
  ...
  - Example: "The **material inventory accumulates** raw materials that arrive at a rate determined by supplier deliveries. Materials undergo quality inspection at a processing pace limited by inspector capacity. The inspection pass rate adjusts based on downstream defect feedback with a **2-week delay**. **Balancing feedback**: Higher defects → stricter standards → lower pass rate → fewer defects. Approved materials **build up in staging inventory** ready for production use."
...
1. "Material Intake":
   - Narrative: The **supplier pipeline accumulates** raw materials that arrive at a rate driven by purchase orders placed weeks in advance. Materials **build up in an inspection queue** where they are processed at a pace limited by inspector availability (typically 100 units per day per inspector). The **inspection pass rate** adjusts based on downstream defect feedback with a **2-week response delay** - when defects increase, standards tighten within days. **Balancing feedback**: Higher defect rates lead to stricter inspection standards, which reduces the pass rate, ultimately bringing defects back down (goal-seeking behavior). Approved materials **accumulate in staging inventory** ready for production. Customer demand signals influence the material arrival rate, but with a **4-6 week procurement delay**. **Nonlinearity**: Inspection effectiveness drops sharply when queue exceeds 500 units due to inspector fatigue.
...
2. "Production Assembly":
   - Narrative: Staging inventory feeds production lines where **work-in-progress accumulates** at an allocation rate determined by available machine capacity (measured in machine-hours per week). The **production completion rate** transforms materials into finished goods at a pace limited by workforce availability and equipment utilization. Quality defects discovered during assembly feed back to Material Intake with a **1-week delay**, affecting inspection standards. **Balancing feedback**: When distribution capacity becomes constrained, a production rate adjustment signal slows the allocation rate, preventing warehouse overflow. Assembly typically takes **3-5 days per unit** depending on complexity. **Nonlinearity**: Production efficiency drops sharply when equipment utilization exceeds 90% due to bottlenecks and increased setup times. The **finished goods inventory builds up** at the completion rate minus the distribution rate.
...
3. "Distribution Preparation":
   - Narrative: Finished goods flow into a **distribution warehouse that accumulates inventory** at the incoming rate from production. Products undergo final inspection at a processing rate limited by inspection capacity (typically 200 units per day). Warehouse capacity constraints create a capacity gap between maximum storage and current occupancy. **Balancing feedback**: As the capacity gap narrows, a capacity constraint signal strengthens, causing production to slow until the gap widens again (goal-seeking toward 70% target capacity). **Customer orders accumulate** at an arrival rate that varies with seasonal market demand patterns. The shipping rate depletes warehouse inventory based on order fulfillment priorities. **Delay**: Demand signals take **2-3 weeks** to propagate back through the system to Material Intake. **Threshold**: When warehouse occupancy exceeds 80%, the constraint signal activates sharply, effectively halting production within 48 hours. **Order backlog builds up** when arrival rate exceeds shipping capacity.
...
✓ **DO write mechanistic narratives** - describe accumulations, rates, feedback loops, delays, and causal drivers WITHOUT labeling types (see "CRITICAL: Writing SD-Ready Process Narratives" section above)
✓ **DO NOT label variable types** - never use (Stock), (Flow), or (Auxiliary) labels - that's Step 2's job
